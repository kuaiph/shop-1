<?php /* Smarty version Smarty-3.1.6, created on 2018-11-14 19:00:10
         compiled from "F:/wamp/www/shop/Home/View\User\register.html" */ ?>
<?php /*%%SmartyHeaderCode:168045bebf8b21e9f41-71433375%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7b332146b9c7b6c3aa02b625691c7219b90b8405' => 
    array (
      0 => 'F:/wamp/www/shop/Home/View\\User\\register.html',
      1 => 1542193204,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '168045bebf8b21e9f41-71433375',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_5bebf8b26b19a',
  'variables' => 
  array (
    'errorInfo' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_5bebf8b26b19a')) {function content_5bebf8b26b19a($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="width:87%;">
                                            ...
                                            <?php echo (($tmp = @$_smarty_tpl->tpl_vars['errorInfo']->value['username'])===null||$tmp==='' ? '' : $tmp);?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <span style="color:red;">
                                            <?php echo (($tmp = @$_smarty_tpl->tpl_vars['errorInfo']->value['password2'])===null||$tmp==='' ? '' : $tmp);?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <span style="color:red;">
                                            <?php echo (($tmp = @$_smarty_tpl->tpl_vars['errorInfo']->value['user_email'])===null||$tmp==='' ? '' : $tmp);?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <span style="color:red;">
                                            <?php echo (($tmp = @$_smarty_tpl->tpl_vars['errorInfo']->value['user_qq'])===null||$tmp==='' ? '' : $tmp);?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select name="user_xueli" id="User_user_xueli">
                                              ...
                                              <span style="color:red;">
                                            <?php echo (($tmp = @$_smarty_tpl->tpl_vars['errorInfo']->value['user_xueli'])===null||$tmp==='' ? '' : $tmp);?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <span style="color:red;">
                                            <?php echo (($tmp = @$_smarty_tpl->tpl_vars['errorInfo']->value['user_hobby'])===null||$tmp==='' ? '' : $tmp);?>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <input name="Submit" value="确定注册" class="us_Submit_reg" style="color: red;background-color:#efefef;border: 1px solid black;" type="submit" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">&nbsp;</td>
